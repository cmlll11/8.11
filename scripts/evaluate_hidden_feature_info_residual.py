"""Measure hidden-feature entropy for the separate x+f(x) GAP mappings."""
...
def main() -> None:
    ...
    for side, goal in CONDITIONS:
        checkpoint_path = mapping_path(Path(args.mapping_root), side, goal)
    ...
    summary = {
        "protocol": "MDL-UAP-hidden-feature-residual-v1",
        "mapping_form": "x+f(x)",
        "split": "test",
        "n_samples": args.n_samples,
        "quantization_bits": args.quantization_bits,
